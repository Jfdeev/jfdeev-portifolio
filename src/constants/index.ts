...
export const HERO_CONTENT = `Sou um desenvolvedor full stack com um talento especial para criar soluções web robustas e escaláveis. Com 1 ano de experiência prática, aprimorei minhas habilidades em tecnologias front-end como React e Next.js, React Native, bem como tecnologias back-end como Node.js, MySQL, Express, .NET e Java, atualmente eu sou um Desenvolvedor de Software na Dti digital. Meu objetivo é alavancar minha experiência para criar soluções inovadoras que impulsionem o crescimento dos negócios e ofereçam experiências excepcionais ao usuário.`;

export const ABOUT_TEXT = `Olá! Sou Jfdeev, um desenvolvedor full stack apaixonado por criar soluções digitais inovadoras. Com experiência em React, Next.js, Node.js e bancos de dados SQL e NoSQL, estou sempre em busca de novos desafios para aprimorar minhas habilidades e contribuir para projetos impactantes. Vamos construir algo incrível juntos!`;
...
export const EXPERIENCES = [
  ...
  {
    year: "2024 - 2025",
    role: "Frontend Developer · BlivUp",
    description: `Designed and developed user interfaces for web applications using Next.js and React. Worked closely with backend developers to integrate frontend components with Node.js APIs. Implemented responsive designs and optimized frontend performance.`,
    technologies: ["React Native", "Tailwind CSS", "Swift", "Axios", "Node.js"],
  },
];
